...
class AnimationRunner(bpy.types.Operator):
    ...
    bl_label = "OpenCV Animation Runner"
     
    # p = our pre-treined model directory
    #p = "D:\\path\\to\\shape_predictor_68_face_landmarks.dat" # Windows
    #p = "/path/to/Downloads/shape_predictor_68_face_landmarks.dat" # macOS
...
def register():
    bpy.utils.register_class(AnimationRunner)

def unregister():
    bpy.utils.unregister_class(AnimationRunner)
